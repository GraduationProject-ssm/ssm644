...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=43)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对课程信息信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款健身房会员管理系统这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短课程信息信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约课程信息信息管理需要的人力和资金。所以健身房会员管理系统是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对课程信息信息管理，采用健身房会员管理系统可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用健身房会员管理系统，其意义如下：

第一点：健身房会员管理系统的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对健身房会员管理系统设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对健身房会员管理系统进行介绍时，将按照如下内容进行。

第一部分：介绍健身房会员管理系统研究的背景意义，便于用户了解系统；

第二部分：介绍开发健身房会员管理系统需要搭建的环境，包括技术和工具；

第三部分：介绍用户对健身房会员管理系统的功能要求，以及对健身房会员管理系统的性能要求等；
...
# 第2章 开发环境与技术
健身房会员管理系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对健身房会员管理系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，健身房会员管理系统开发可行。
### 3.1.3 操作可行性
健身房会员管理系统根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作健身房会员管理系统。
...
![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\用户.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\用户.jpg")
图4.1 用户实体属性图

（2）下图是商品兑换记录实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\商品兑换记录.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\商品兑换记录.jpg")
图4.2 商品兑换记录实体属性图

（3）下图是店长实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\店长.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\店长.jpg")
图4.3 店长实体属性图

（4）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\公告信息.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\公告信息.jpg")
图4.4 公告信息实体属性图

（5）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\字典表.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\字典表.jpg")
图4.5 字典表实体属性图

（6）下图是教练实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\教练.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\教练.jpg")
图4.6 教练实体属性图

（7）下图是课程信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\课程信息.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\课程信息.jpg")
图4.7 课程信息实体属性图

（8）下图是论坛实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\论坛.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\论坛.jpg")
图4.8 论坛实体属性图

（9）下图是商品实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\商品.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\商品.jpg")
图4.9 商品实体属性图

（10）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\用户表.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\用户表.jpg")
图4.10 用户表实体属性图

（11）下图是课程评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\课程评价.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\课程评价.jpg")
图4.11 课程评价实体属性图

（12）下图是课程订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\课程订单.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\jianshenfanghuiyuan\课程订单.jpg")
图4.12 课程订单实体属性图
### 4.3.2 数据库物理设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|dianzhang\_name|String|店长姓名|是|
|3|dianzhang\_photo|String|头像|是|
|4|dianzhang\_phone|String|联系方式|是|
...
|5|kecheng\_price|Integer|购买获得积分|是|
|6|kecheng\_types|Integer|课程类型|是|
|7|kecheng\_kucun\_number|Integer|可预约人数|是|
|8|kecheng\_new\_money|BigDecimal|价格|是|
|9|kecheng\_delete|Integer|逻辑删除|是|
|10|kecheng\_content|String|课程简介|是|
...
|3|yonghu\_id|Integer|用户|是|
|4|kecheng\_commentback\_text|String|评价内容|是|
...
|5|buy\_number|Integer|预定数量|是|
|6|kecheng\_order\_types|Integer|订单类型|是|
...
|6|shangpin\_new\_money|BigDecimal|积分|是|
|7|shangpin\_duihuannum|Integer|兑换次数|是|
|8|shangxia\_types|Integer|是否上架|是|
|9|shangpin\_delete|Integer|逻辑删除|是|
|10|shangpin\_content|String|商品简介|是|
|11|create\_time|Date|创建时间|是|
表4.10商品兑换记录表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shangpin\_order\_uuid\_number|String|编号|是|
|3|shangpin\_id|Integer|商品|是|
|4|yonghu\_id|Integer|用户|是|
|5|buy\_number|Integer|兑换数量|是|
...
|8|yonghu\_jifen|BigDecimal|现积分|是|
|9|huanyuan\_types|Integer|会员类型|是|
|10|huiyuandaoqi\_time|Date|会员到期时间|是|
...
图5.2 课程信息管理页面
### 5.3课程评论管理
如图5.3显示的就是课程评论管理页面，此页面提供给管理员的功能有：根据课程评论进行条件查询，还可以对课程评论进行新增、修改、查询操作等等。
